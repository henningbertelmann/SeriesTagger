...
public class DataModel {
	public static class Episode {
		...
		public String toString(){
			...
			return series_name + " -  S" + season_number + "E" + episode_number + " - " + title + " ------" + filename;
		}
	...
	public DataModel() {
		...
		this.episodesList.add(new Episode(1,1,"the one with the pilot","Friends"));
		this.episodesList.add(new Episode(1,2,"the one with the second","Friends"));
		// develop begonnen
	}
	...
	/* macthes a file with an episode 
	 * The file will be removed from the filelist and it will be added to the episode,
	 * int the episode list
	 */
